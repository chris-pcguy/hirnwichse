...
CPU_REGISTER_DREG = (CPU_REGISTER_DR0, CPU_REGISTER_DR1, CPU_REGISTER_DR2, CPU_REGISTER_DR3, CPU_REGISTER_NONE, \
...
cdef unsigned char CPU_EXCEPTIONS_FAULT_GROUP[12]
...
cdef unsigned char CPU_EXCEPTIONS_TRAP_GROUP[3]
CPU_EXCEPTIONS_TRAP_GROUP = (CPU_EXCEPTION_DB, CPU_EXCEPTION_BP, CPU_EXCEPTION_OF)

cdef unsigned char CPU_EXCEPTIONS_WITH_ERRORCODE[7]
...
cdef unsigned char OPCODE_PREFIX_SEGMENTS[6]
...
cdef unsigned char OPCODE_PREFIX_REPS[2]
OPCODE_PREFIX_REPS = (OPCODE_PREFIX_REPNE,OPCODE_PREFIX_REPE)


cdef unsigned char OPCODE_PREFIXES[11]
OPCODE_PREFIXES = (OPCODE_PREFIX_OP, OPCODE_PREFIX_ADDR, OPCODE_PREFIX_CS,
