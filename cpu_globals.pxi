...
cdef uint8_t OPCODE_ADD  = 0
cdef uint8_t OPCODE_OR   = 1
cdef uint8_t OPCODE_ADC  = 2
cdef uint8_t OPCODE_SBB  = 3
cdef uint8_t OPCODE_AND  = 4
cdef uint8_t OPCODE_SUB  = 5
cdef uint8_t OPCODE_XOR  = 6
cdef uint8_t OPCODE_CMP  = 7
cdef uint8_t OPCODE_SAVE = 8
...
cdef uint8_t CPU_CLOCK_TICK_SHIFT = 1
