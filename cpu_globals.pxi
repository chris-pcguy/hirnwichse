...
DEF CPU_SEGMENT_CS = 10
DEF CPU_SEGMENT_SS = 11
DEF CPU_SEGMENT_DS = 12
DEF CPU_SEGMENT_ES = 13
DEF CPU_SEGMENT_FS = 14
DEF CPU_SEGMENT_GS = 15

DEF CPU_REGISTER_CR0 = 16
DEF CPU_REGISTER_CR2 = 17
DEF CPU_REGISTER_CR3 = 18
DEF CPU_REGISTER_CR4 = 19

DEF CPU_REGISTER_DR0 = 20
DEF CPU_REGISTER_DR1 = 21
DEF CPU_REGISTER_DR2 = 22
DEF CPU_REGISTER_DR3 = 23
DEF CPU_REGISTER_DR6 = 24
DEF CPU_REGISTER_DR7 = 25

DEF CPU_REGISTER_NONE = 26
...
cdef tuple CPU_REGISTER_SREG = (CPU_SEGMENT_ES,CPU_SEGMENT_CS,CPU_SEGMENT_SS,CPU_SEGMENT_DS,CPU_SEGMENT_FS,CPU_SEGMENT_GS, \
                                CPU_REGISTER_NONE, CPU_REGISTER_NONE)
cdef tuple CPU_REGISTER_CREG = (CPU_REGISTER_CR0, CPU_REGISTER_NONE, CPU_REGISTER_CR2, CPU_REGISTER_CR3, CPU_REGISTER_CR4, \
                                CPU_REGISTER_NONE, CPU_REGISTER_NONE, CPU_REGISTER_NONE)
cdef tuple CPU_REGISTER_DREG = (CPU_REGISTER_DR0, CPU_REGISTER_DR1, CPU_REGISTER_DR2, CPU_REGISTER_DR3, CPU_REGISTER_NONE, \
                                CPU_REGISTER_NONE, CPU_REGISTER_DR6, CPU_REGISTER_DR7)

cdef tuple CPU_MODRM_8BIT = (CPU_REGISTER_AL, CPU_REGISTER_CL, CPU_REGISTER_DL, CPU_REGISTER_BL, CPU_REGISTER_AH, \
                             CPU_REGISTER_CH, CPU_REGISTER_DH, CPU_REGISTER_BH, )

cdef tuple CPU_MODRM_16BIT_RM0 = (CPU_REGISTER_RBX, CPU_REGISTER_RBX, CPU_REGISTER_RBP, CPU_REGISTER_RBP, CPU_REGISTER_RSI, \
                                  CPU_REGISTER_RDI, CPU_REGISTER_RBP, CPU_REGISTER_RBX)

cdef tuple CPU_MODRM_16BIT_RM1 = (CPU_REGISTER_RSI, CPU_REGISTER_RDI, CPU_REGISTER_RSI, CPU_REGISTER_RDI, CPU_REGISTER_NONE, \
                                  CPU_REGISTER_NONE, CPU_REGISTER_NONE, CPU_REGISTER_NONE)
