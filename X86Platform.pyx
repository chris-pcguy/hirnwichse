...
cdef class Platform:
    ...
    cdef void initDevicesPorts(self):
        ...
        self.addReadHandlers(ATA_FIRST_PORTS_IOBASE1, self.ata, <InPort>self.ata.inPort)
        self.addReadHandlers(ATA_FIRST_PORTS_IOBASE2, self.ata, <InPort>self.ata.inPort)
        self.addReadHandlers(ATA_SECOND_PORTS_IOBASE1, self.ata, <InPort>self.ata.inPort)
        self.addReadHandlers(ATA_SECOND_PORTS_IOBASE2, self.ata, <InPort>self.ata.inPort)
        self.addReadHandlers(ATA_THIRD_PORTS_IOBASE1, self.ata, <InPort>self.ata.inPort)
        self.addReadHandlers(ATA_THIRD_PORTS_IOBASE2, self.ata, <InPort>self.ata.inPort)
        self.addReadHandlers(ATA_FOURTH_PORTS_IOBASE1, self.ata, <InPort>self.ata.inPort)
        self.addReadHandlers(ATA_FOURTH_PORTS_IOBASE2, self.ata, <InPort>self.ata.inPort)
        ...
        self.addWriteHandlers(ATA_FIRST_PORTS_IOBASE1, self.ata, <OutPort>self.ata.outPort)
        self.addWriteHandlers(ATA_FIRST_PORTS_IOBASE2, self.ata, <OutPort>self.ata.outPort)
        self.addWriteHandlers(ATA_SECOND_PORTS_IOBASE1, self.ata, <OutPort>self.ata.outPort)
        self.addWriteHandlers(ATA_SECOND_PORTS_IOBASE2, self.ata, <OutPort>self.ata.outPort)
        self.addWriteHandlers(ATA_THIRD_PORTS_IOBASE1, self.ata, <OutPort>self.ata.outPort)
        self.addWriteHandlers(ATA_THIRD_PORTS_IOBASE2, self.ata, <OutPort>self.ata.outPort)
        self.addWriteHandlers(ATA_FOURTH_PORTS_IOBASE1, self.ata, <OutPort>self.ata.outPort)
        self.addWriteHandlers(ATA_FOURTH_PORTS_IOBASE2, self.ata, <OutPort>self.ata.outPort)
