...
cdef tuple MODRM_SIB_INDEX_REGS = (CPU_REGISTER_EAX, CPU_REGISTER_ECX, CPU_REGISTER_EDX, CPU_REGISTER_EBX, \
                                   CPU_REGISTER_NONE, CPU_REGISTER_EBP, CPU_REGISTER_ESI, CPU_REGISTER_EDI)
...
DEF VGA_SEQ_DATA_LENGTH = 256
DEF VGA_CRT_DATA_LENGTH = 256
DEF VGA_GDC_DATA_LENGTH = 256
DEF VGA_DAC_DATA_LENGTH = 256
DEF VGA_EXTREG_DATA_LENGTH = 256
DEF VGA_ATTRCTRLREG_DATA_LENGTH = 256
DEF VGA_CURSOR_BASE_ADDR  = 0x450
DEF VGA_CURRENT_MODE_ADDR = 0x449
DEF VGA_CURRENT_CURSOR_TYPE_ADDR = 0x460
DEF VGA_CURRENT_PAGE_ADDR = 0x462
