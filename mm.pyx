...
cdef class Mm:
    def __init__(self, object main):
        self.main = main
        self.mmAreas = []
    cpdef mmAddArea(self, unsigned long long mmBaseAddr, unsigned long long mmAreaSize, unsigned char mmReadOnly=False, object mmAreaObject=MmArea):
    ...
    cpdef mmGetAreas(self, long long mmAddr, unsigned long long dataSize): # dataSize in bytes
        ...
        return foundAreas
    cpdef mmGetRealAddr(self, long long mmAddr, unsigned short segId, unsigned char allowOverride=True):
        ...
        return mmAddr
    cpdef mmPhyRead(self, long long mmAddr, unsigned long long dataSize, int ignoreFail=False): # dataSize in bytes
        cdef object mmArea
    ...
    cpdef mmPhyReadValue(self, long long mmAddr, unsigned long long dataSize, int signed=False): # dataSize in bytes
        ...
        if (signed):
            ...
            retDataUnsigned = int.from_bytes(data, byteorder=misc.BYTE_ORDER_LITTLE_ENDIAN, signed=signed)
            return retDataUnsigned
    cpdef mmRead(self, long long mmAddr, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, unsigned char allowOverride=True): # dataSize in bytes
    ...
    cpdef mmReadValue(self, long long mmAddr, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, int signed=False, unsigned char allowOverride=True): # dataSize in bytes
    ...
    cpdef mmPhyWriteValue(self, long long mmAddr, unsigned long long data, unsigned long long dataSize): # dataSize in bytes
        ...
        data &= bitMask
        cdef object bytesData = data.to_bytes(length=dataSize, byteorder=misc.BYTE_ORDER_LITTLE_ENDIAN)
        self.mmPhyWrite(mmAddr, bytesData, dataSize)
        return data
    cpdef mmWrite(self, long long mmAddr, bytes data, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, unsigned char allowOverride=True): # dataSize in bytes
        self.main.cpu.registers.checkMemAccessRights(segId, True)
        mmAddr = self.mmGetRealAddr(mmAddr, segId, allowOverride=allowOverride)
        self.mmPhyWrite(mmAddr, data, dataSize)
    cpdef mmWriteValueWithOp(self, long long mmAddr, unsigned long long data, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, unsigned char allowOverride=True, unsigned char valueOp=misc.VALUEOP_SAVE): # dataSize in bytes
    ...
    cpdef mmWriteValue(self, long long mmAddr, unsigned long long data, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, unsigned char allowOverride=True): # dataSize in bytes
        mmAddr = self.mmGetRealAddr(mmAddr, segId, allowOverride=allowOverride)
        return self.mmPhyWriteValue(mmAddr, data, dataSize)
    cpdef mmAddValue(self, long long mmAddr, unsigned long long data, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, unsigned char allowOverride=True): # dataSize in bytes, data==int
        cdef unsigned long long bitMask = self.main.misc.getBitMask(dataSize)
        mmAddr = self.mmGetRealAddr(mmAddr, segId, allowOverride=allowOverride)
        return self.mmPhyWriteValue(mmAddr, (self.mmPhyReadValue(mmAddr, dataSize)+data)&bitMask, dataSize)
    cpdef mmAdcValue(self, long long mmAddr, unsigned long long data, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, unsigned char allowOverride=True): # dataSize in bytes, data==int
        cdef unsigned long long bitMask = self.main.misc.getBitMask(dataSize)
    ...
    cpdef mmSubValue(self, long long mmAddr, unsigned long long data, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, unsigned char allowOverride=True): # dataSize in bytes, data==int
        cdef unsigned long long bitMask = self.main.misc.getBitMask(dataSize)
        mmAddr = self.mmGetRealAddr(mmAddr, segId, allowOverride=allowOverride)
        return self.mmPhyWriteValue(mmAddr, (self.mmPhyReadValue(mmAddr, dataSize)-data)&bitMask, dataSize)
    cpdef mmSbbValue(self, long long mmAddr, unsigned long long data, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, unsigned char allowOverride=True): # dataSize in bytes, data==int
        cdef unsigned long long bitMask = self.main.misc.getBitMask(dataSize)
        cdef unsigned char withCarry = self.main.cpu.registers.getEFLAG( registers.FLAG_CF )
        mmAddr = self.mmGetRealAddr(mmAddr, segId, allowOverride=allowOverride)
        return self.mmPhyWriteValue(mmAddr, (self.mmPhyReadValue(mmAddr, dataSize)-(data+withCarry))&bitMask, dataSize)
    cpdef mmAndValue(self, long long mmAddr, unsigned long long data, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, unsigned char allowOverride=True): # dataSize in bytes, data==int
        ###cdef unsigned long long bitMask = self.main.misc.getBitMask(dataSize)
        mmAddr = self.mmGetRealAddr(mmAddr, segId, allowOverride=allowOverride)
        return self.mmPhyWriteValue(mmAddr, self.mmPhyReadValue(mmAddr, dataSize)&data, dataSize)
    cpdef mmOrValue(self, long long mmAddr, unsigned long long data, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, unsigned char allowOverride=True): # dataSize in bytes, data==int
        ###cdef unsigned long long bitMask = self.main.misc.getBitMask(dataSize)
        mmAddr = self.mmGetRealAddr(mmAddr, segId, allowOverride=allowOverride)
        return self.mmPhyWriteValue(mmAddr, self.mmPhyReadValue(mmAddr, dataSize)|data, dataSize)
    cpdef mmXorValue(self, long long mmAddr, unsigned long long data, unsigned long long dataSize, unsigned short segId=registers.CPU_SEGMENT_DS, unsigned char allowOverride=True): # dataSize in bytes, data==int
        ###cdef unsigned long long bitMask = self.main.misc.getBitMask(dataSize)
        mmAddr = self.mmGetRealAddr(mmAddr, segId, allowOverride=allowOverride)
        return self.mmPhyWriteValue(mmAddr, self.mmPhyReadValue(mmAddr, dataSize)^data, dataSize)
...
cdef class ConfigSpace:
    ...
    cpdef csWrite(self, unsigned long long offset, bytes data, unsigned long long size): # dataSize in bytes; use 'signed' only if writing 'int'
        ...
        return size
    cpdef csReadValue(self, unsigned long long offset, unsigned long long size, int signed=False): # dataSize in bytes
